...
import { TrendingUp, DollarSign, Shield, Lightbulb, HeartHandshake } from "lucide-react";
...
const benefits = [
  ...
  },
  {
    ...
    description: "Procesos más ágiles que impulsan el crecimiento de su empresa"
  },
  {
    icon: Shield,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Resultados concretos que transformarán la manera en que su PyME opera y compite en el mercado.
          </p>
        </div>
