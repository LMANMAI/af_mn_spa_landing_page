  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        {/* SCROLLER en móviles/tablet; columnas normales en lg+ */}
        <div className="relative">
          <div
            style={{ overflowX: "auto", padding: "20px 0px" }}
            className="flex gap-6 overflow-x-auto flex-nowrap-mx-4 px-4 snap-x snap-mandatory scroll-smooth lg:flex-wrap lg:overflow-visible lg:-mx-4 lg:px-0"
          >
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className="
                    shrink-0 w-[300px] sm:w-[340px] md:w-[360px] snap-start
                    lg:shrink lg:w-auto lg:basis-1/3 lg:px-4
                  "
                >
                  <Card
                    className="
